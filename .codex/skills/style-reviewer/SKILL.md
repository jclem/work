...
Prioritize:
- Conformance with `/Users/jclem/src/github.com/jclem/work/AGENTS.md` (`CLI style guide` and `Rust style guide` sections).
...
1. Load context:
- Read `/Users/jclem/src/github.com/jclem/work/AGENTS.md`.
